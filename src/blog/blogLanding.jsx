...
const BlogLandingPage = () => {
    ...
    const articles = [
      ...
      { id:"hospitable_sender_blog", title:"HostBuddy Now Supports Hospitable Sender Selection for Airbnb", date:"Nov 20, 2024", img:hospitable_sender_blog_thumbnail, description:"Finally, the control you've been asking for is here. Choose exactly which host profile sends your automated AI messages with HostBuddy's new Hospitable Sender Selection feature." },
    ];
