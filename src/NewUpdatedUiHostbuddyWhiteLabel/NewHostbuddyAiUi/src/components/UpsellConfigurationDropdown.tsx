...
interface UpsellConfigurationDropdownProps {
  configurations: UpsellConfiguration[];
  selectedConfigId: string;
  onSelectConfig: (configId: string) => void;
  onNewConfig: () => void;
}

export default function UpsellConfigurationDropdown({
  configurations,
  selectedConfigId,
  onSelectConfig,
  onNewConfig
}: UpsellConfigurationDropdownProps) {
