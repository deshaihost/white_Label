export const AddPropertiesActionTypes = {
    ...
    REMOVE_SUPPORTING_DOCS_EMPTY_FIRST: '@@auth/REMOVE_SUPPORTING_DOCS_EMPTY_FIRST',
    REMOVE_SUPPORTING_DOCS_EMPTY_SUCCESS: '@@auth/REMOVE_SUPPORTING_DOCS_EMPTY_SUCCESS',
};
