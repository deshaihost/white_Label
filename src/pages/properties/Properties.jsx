                ...
                <div className="account_heading">
                  ...
                  <div className="property-heading-right">
                    ...
                    <div class="form-check form-switch custom_switch">
                        <input class="form-check-input toggle-user-chatbot" type="checkbox" role="switch" id="statuscheck" checked="checked" />
                        <label class="form-check-label" for="statuscheck">On</label>
                    </div>
                    <div class="expendable_search">
