  ...
  const onSubmit = (data) => {
    ...
    if (Booking) {
      ...
      if (addedNote && "booking_short_answer0_hidereservation" in addedNote) {
        Booking[0]["hide_for_reservations"] = addedNote?.booking_short_answer0_hidereservation ?? "";
      }
      ...
      if (addedNote && "booking_select1_hidereservation" in addedNote) {
        Booking[1]["hide_for_reservations"] = addedNote?.booking_select1_hidereservation ?? "";
      }
      ...
      if (addedNote && "booking_select2_hidereservation" in addedNote) {
        Booking[2]["hide_for_reservations"] = addedNote?.booking_select2_hidereservation ?? "";
      }
      ...
      if (addedNote && "booking_short_answer3_hidereservation" in addedNote) {
        Booking[3]["hide_for_reservations"] = addedNote?.booking_short_answer3_hidereservation ?? "";
      }
      ...
      if (addedNote && "booking_short_answer4_hidereservation" in addedNote) {
        Booking[4]["hide_for_reservations"] = addedNote?.booking_short_answer4_hidereservation ?? "";
      }
      ...
      if (addedNote && "booking_short_answer5_hidereservation" in addedNote) {
        Booking[5]["hide_for_reservations"] = addedNote?.booking_short_answer5_hidereservation ?? "";
      }
      ...
      if (addedNote && "booking_select6_hidereservation" in addedNote) {
        Booking[6]["hide_for_reservations"] = addedNote?.booking_select6_hidereservation ?? "";
      }
    }
    ...
    if (checkInandCheckout) {
      ...
      if (addedNote && "checkInOut_short_answer0_hidereservation" in addedNote) {
        checkInandCheckout[0]["hide_for_reservations"] = addedNote?.checkInOut_short_answer0_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_short_answer1_hidereservation" in addedNote) {
        checkInandCheckout[1]["hide_for_reservations"] = addedNote?.checkInOut_short_answer1_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_short_answer2_hidereservation" in addedNote) {
        checkInandCheckout[2]["hide_for_reservations"] = addedNote?.checkInOut_short_answer2_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_long_answer3_hidereservation" in addedNote) {
        checkInandCheckout[3]["hide_for_reservations"] = addedNote?.checkInOut_long_answer3_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_short_answer4_hidereservation" in addedNote) {
        checkInandCheckout[4]["hide_for_reservations"] = addedNote?.checkInOut_short_answer4_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_short_answer5_hidereservation" in addedNote) {
        checkInandCheckout[5]["hide_for_reservations"] = addedNote?.checkInOut_short_answer5_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_long_answer6_hidereservation" in addedNote) {
        checkInandCheckout[6]["hide_for_reservations"] = addedNote?.checkInOut_long_answer6_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_long_answer7_hidereservation" in addedNote) {
        checkInandCheckout[7]["hide_for_reservations"] = addedNote?.checkInOut_long_answer7_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_long_answer8_hidereservation" in addedNote) {
        checkInandCheckout[8]["hide_for_reservations"] = addedNote?.checkInOut_long_answer8_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_short_answer9_hidereservation" in addedNote) {
        checkInandCheckout[9]["hide_for_reservations"] = addedNote?.checkInOut_short_answer9_hidereservation ?? "";
      }
      ...
      if (addedNote && "checkInOut_short_answer10_hidereservation" in addedNote) {
        checkInandCheckout[10]["hide_for_reservations"] = addedNote?.checkInOut_short_answer10_hidereservation ?? "";
      }
    }
    ...
    if (Details) {
      ...
      if (addedNote && "details_short_answer0_hidereservation" in addedNote) {
        Details[0]["hide_for_reservations"] = addedNote?.details_short_answer0_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_short_answer1_hidereservation" in addedNote) {
        Details[1]["hide_for_reservations"] = addedNote?.details_short_answer1_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_short_answer2_hidereservation" in addedNote) {
        Details[2]["hide_for_reservations"] = addedNote?.details_short_answer2_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_short_answer3_hidereservation" in addedNote) {
        Details[3]["hide_for_reservations"] = addedNote?.details_short_answer3_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_short_answer4_hidereservation" in addedNote) {
        Details[4]["hide_for_reservations"] = addedNote?.details_short_answer4_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_short_answer5_hidereservation" in addedNote) {
        Details[5]["hide_for_reservations"] = addedNote?.details_short_answer5_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_long_answer6_hidereservation" in addedNote) {
        Details[6]["hide_for_reservations"] = addedNote?.details_long_answer6_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_short_answer7_hidereservation" in addedNote) {
        Details[7]["hide_for_reservations"] = addedNote?.details_short_answer7_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_short_answer8_hidereservation" in addedNote) {
        Details[8]["hide_for_reservations"] = addedNote?.details_short_answer8_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_short_answer9_hidereservation" in addedNote) {
        Details[9]["hide_for_reservations"] = addedNote?.details_short_answer9_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_short_answer10_hidereservation" in addedNote) {
        Details[10]["hide_for_reservations"] = addedNote?.details_short_answer10_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_long_answer11_hidereservation" in addedNote) {
        Details[11]["hide_for_reservations"] = addedNote?.details_long_answer11_hidereservation ?? "";
      }
      ...
      if (addedNote && "details_long_answer12_hidereservation" in addedNote) {
        Details[12]["hide_for_reservations"] = addedNote?.details_long_answer12_hidereservation ?? "";
      }
