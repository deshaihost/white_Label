...
const PencilIcon = ({ sec_name, subsec_name, q_ind, checkbox_group_option, handlePencilIconClick, someResStageIsSelected }) => {
  
  return (
    <Button style={{ width: "auto" }} className="bg-none p-0 border-0 d-inline shadow-none" onClick={() => handlePencilIconClick(sec_name, subsec_name, q_ind, checkbox_group_option)}>
