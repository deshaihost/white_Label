...
const QuestionnaireFirstPage = ({questionnaire_section_name, handleInputComponentChange, handlePencilIconClick, handleSaveAndNext, triggeredSaveLoading, property_name, section_num, num_total_sections}) => {
  ...
  return (
    <div className="form-design">
      ...
      <IntegrationsForm property_name={property_name} />
      <div style={{ marginBottom: '80px' }}></div> {/* Spacer */}

      {/* Document details & options */}
      <div style={{ marginBottom: '80px' }}></div> {/* Spacer */}
      <DocumentForm property_name={property_name} />
      <div style={{ marginBottom: '80px' }}></div> {/* Spacer */}
