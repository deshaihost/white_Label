    ...
    <div className="smart-templates-landing">
      ...
      <div className="unmatched">
        <div className="container">
          <h1>
            Templated Messages <span>For Everything</span>.
          </h1>
          <div className="row first-section">
            ...
            <div className="col-lg-7">
              <p>HostBuddy provides the most advanced templated messaging support in short-term rentals. Target any subset of your guests by choosing from a multitude of timing options and conditions. Use AI to bring context awareness and to add a human-like touch to your messages.</p>
            ...
            <div className="row">
              <div className="col-lg-7 col-md-7 left-column">
                ...
                <div className="icon-boc-con">
                  ...
                  <p>Choose from a myriad of conditions and parameters to narrow down on the specific set of guests you want to message.</p>
                </div>
                <div className="icon-boc-con">
              ...
              <div className="col-lg-5 col-md-5 right-column">
