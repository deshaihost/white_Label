...
const PostStayUpsells = ({setSection, settingsApiData, setSettingsApiData, currentSettingsData, setCurrentSettingsData, callGetSettingsApi, getSettingsLoading, callGetUpcomingMessagesApi, getUpcomingMessagesLoading, upcomingMessagesData}) => {
  ...
  const callSaveSettingsApi = async () => {
    ...
    try {
      ...
      const body_data = { name:'default', settings:currentSettingsData, upsell_type:'post_stay' };
  ...
  const callCancelMessageApi = async (propertyName, guestKey) => {
    ...
    try {
      ...
      const body_data = { property_name:propertyName, guest_key:guestKey, upsell_type:'post_stay' };
      ...
      */}
      ...
      <div className="col-12 mt-4">
        <div style={{ backgroundColor: '#0F1117', border: '2px solid #013280', borderRadius: '12px', overflow: 'hidden' }}>
          <table style={{ width: '100%', marginBottom: '0', borderCollapse: 'separate', borderSpacing: '0', backgroundColor: 'var(--white-label-background-secondary, #17191F)', borderColor: '#013280', borderWidth: '1px' }}>
            <thead>
              <tr style={{ backgroundColor: '#0F1117' }}>
                <th style={{ padding: '12px 24px', textAlign: 'left', color: '#a6a9b2', fontSize: '12px', fontFamily: "'DM Sans', sans-serif", fontWeight: '600', textTransform: 'uppercase', fontVariationSettings: "'opsz' 14", borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderRightWidth: '1px', borderRightStyle: 'solid', borderRightColor: '#013280', borderColor: '#013280', backgroundColor: '#0F1117' }}>Sending on</th>
                <th style={{ padding: '12px 24px', textAlign: 'left', color: '#a6a9b2', fontSize: '12px', fontFamily: "'DM Sans', sans-serif", fontWeight: '600', textTransform: 'uppercase', fontVariationSettings: "'opsz' 14", borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderRightWidth: '1px', borderRightStyle: 'solid', borderRightColor: '#013280', borderColor: '#013280', backgroundColor: '#0F1117' }}>Property</th>
                <th style={{ padding: '12px 24px', textAlign: 'left', color: '#a6a9b2', fontSize: '12px', fontFamily: "'DM Sans', sans-serif", fontWeight: '600', textTransform: 'uppercase', fontVariationSettings: "'opsz' 14", borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderRightWidth: '1px', borderRightStyle: 'solid', borderRightColor: '#013280', borderColor: '#013280', backgroundColor: '#0F1117' }}>Guest</th>
                <th style={{ padding: '12px 24px', textAlign: 'left', color: '#a6a9b2', fontSize: '12px', fontFamily: "'DM Sans', sans-serif", fontWeight: '600', textTransform: 'uppercase', fontVariationSettings: "'opsz' 14", borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderRightWidth: '1px', borderRightStyle: 'solid', borderRightColor: '#013280', borderColor: '#013280', backgroundColor: '#0F1117' }}>Vacant Night</th>
                {/* <th>Status</th> tbh there's no need for this, since current implementation only shows "waiting to send" messages to the user */}
                <th style={{ padding: '12px 24px', textAlign: 'left', color: '#a6a9b2', fontSize: '12px', fontFamily: "'DM Sans', sans-serif", fontWeight: '600', textTransform: 'uppercase', fontVariationSettings: "'opsz' 14", borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderColor: '#013280', backgroundColor: '#0F1117' }}>Action</th>
              </tr>
            </thead>
            {!getUpcomingMessagesLoading ? (
              upcomingMessagesData && upcomingMessagesData.length > 0 ? (
                <tbody style={{ backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>
                  {upcomingMessagesData.slice(0, 10).map((message, index) => ( // only show the first 20
                    <tr key={index} style={{ backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>
                      <td style={{ padding: '12px 24px', color: 'white', fontSize: '14px', fontFamily: "'DM Sans', sans-serif", fontWeight: '400', fontVariationSettings: "'opsz' 14", borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderRightWidth: '1px', borderRightStyle: 'solid', borderRightColor: '#013280', borderColor: '#013280', backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>{formatDateTime(message.time_to_send)}</td>
                      <td style={{ padding: '12px 24px', color: 'white', fontSize: '14px', fontFamily: "'DM Sans', sans-serif", fontWeight: '400', fontVariationSettings: "'opsz' 14", borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderRightWidth: '1px', borderRightStyle: 'solid', borderRightColor: '#013280', borderColor: '#013280', backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>{truncateString(message.property_name, 25)}</td>
                      <td style={{ padding: '12px 24px', color: 'white', fontSize: '14px', fontFamily: "'DM Sans', sans-serif", fontWeight: '400', fontVariationSettings: "'opsz' 14", borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderRightWidth: '1px', borderRightStyle: 'solid', borderRightColor: '#013280', borderColor: '#013280', backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>{`${truncateString(message.guest_first_name, 13)} (${formatDateRange(message.guest_check_in, message.guest_check_out)})`}</td>
                      <td style={{ padding: '12px 24px', color: 'white', fontSize: '14px', fontFamily: "'DM Sans', sans-serif", fontWeight: '400', fontVariationSettings: "'opsz' 14", borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderRightWidth: '1px', borderRightStyle: 'solid', borderRightColor: '#013280', borderColor: '#013280', backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>{formatDateRange(message.start_date, message.end_date)}</td>
                      ...
                      <td style={{ padding: '12px 24px', borderBottomWidth: '1px', borderBottomStyle: 'solid', borderBottomColor: '#013280', borderColor: '#013280', backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>
                ...
                <tbody style={{ backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>
                  <tr style={{ backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>
                    <td colSpan="5" style={{ padding: '24px', textAlign: 'center', color: '#a6a9b2', fontSize: '14px', fontFamily: "'DM Sans', sans-serif", fontWeight: '400', fontVariationSettings: "'opsz' 14", backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>
                      {!currentSettingsData.enabled ? 'Post-stay upsells are off' : 'No upcoming messages'}
                    </td>
                  </tr>
                </tbody>
              )
              ...
              <tbody style={{ backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>
                <tr style={{ backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>
                  <td colSpan="5" style={{ padding: '24px', textAlign: 'center', backgroundColor: 'var(--white-label-background-secondary, #17191F)' }}>
                    <BoxLoader />
                  </td>
                </tr>
              </tbody>
