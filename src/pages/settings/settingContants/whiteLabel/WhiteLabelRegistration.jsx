          ...
          <div className="demo-preview-container">
            ...
            {!showPreview ? (
              ...
              <div style={{ 
                ...
                <iframe
                  src={`https://${previewDomain || 'testhostbuddy.online'}/client-login?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..oa_3pIL1Oy9HttSUS--XEapryU_4aeFYGVHFOc84ftg&redirect=dashboard`}
                  style={{
                    width: '100%',
                    height: '100%',
                    border: 'none'
