...
const Dashboard = () => {
  ...
  console.log(userDataGet?.statistics,'userDataGet?.statisticsuserDataGet?.statistics')
            ...
            <div className="col-lg-8">
              <div className="account-container">
                ...
                <div className="account-content">
                  <div className="row">
                    ...
                    <div className="col-lg-4">
                      <div className="get-started">
                        ...
                        <p>
                          Explore how to set up and get started with HostBuddy
                        </p>
                  ...
                  <div className="row">
                  {!actionItemsCovertationLoading?<div className="border">
                  <h3 className="text-white my-3">ACTION ITEMS</h3>
                        ...
                        {Object?.keys(actionItems)?.map((property) =>
                          Object?.keys(actionItems[property])?.map((itemId) => {
                            ...
                            return (
                              <tr key={itemId}>
                                <td>
                                  {formatDateTime(item?.items[0]?.created_at)}
                                </td>
                                <td>{property}</td>
                                <td>{item?.items[0]?.item}</td>
                                <td>
                                  <Link to={`/property-insight/${JSON.stringify(actionItem)}`}>
