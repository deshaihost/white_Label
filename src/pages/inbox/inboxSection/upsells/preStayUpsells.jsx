  ...
  return (
    <div className="upsells-settings">
      ...
      {currentSettingsData.enabled ? (
        <p style={{marginTop:'10px'}} className="settings-label">You currently have pre-stay upsells <span style={{color: 'rgb(0, 128, 0)'}}>enabled</span>. Your templated message will send at the scheduled time.</p>
      ) : (
        <p style={{marginTop:'10px'}} className="settings-label">You currently have pre-stay upsells <span style={{color: 'rgb(215, 0, 0)'}}>not enabled</span>. These messages will not be sent.</p>
      )}
