      ...
      <div className="account-main">
        ...
        <div className="container">
          <div className="banner-heading">
            <h2>Guesty Integration via Calry</h2>
          </div>
          <div className="row">
                    ...
                    <div className="col-lg-12">
                      <div className="guide-steps">
                        ...
                        <div className="step-box section" id="step2">
                          <h4>2. Get the API Key from Guesty</h4>
                          <p>Switch over to your Guesty Account in a new tab. Go to <strong>Integrations</strong> <strong>Marketplace</strong> and search for HostBuddy AI. Click on the blue "Connect" button to generate the API key.</p>
                        ...
                        <div className="step-box section" id="step3">
                          ...
                          <p>Paste the API key into the screen shown in Step 1 in the HostBuddy AI app. Once successfully done, you will be redirected back to HostBuddy AI, and your integration will be complete. You're all set to start using HostBuddy AI with Guesty!</p>
                        </div>

                        <div className="step-box section" id="step4">
                          <h4>4. Advanced API Settings (Optional)</h4>
                          <p>If you need additional control over API settings, go back to Guesty, and in the top navigation bar, click the mode selector and choose <strong>Setup Mode</strong>. Then go to <strong>Integrations</strong> and select <strong>API</strong>.</p>
                          <p>Hover over the left side of "API Support", and click the three horizontal dots. Fill in the <strong>Application Name</strong> and <strong>Application Description</strong>, and click <strong>Generate New Secrets</strong>.</p>
                          <p>Enter your Guesty password to confirm. Copy the <strong>Client ID</strong> and <strong>Client Secret</strong> for future use, as these are only visible the first time you access them.</p>
                        </div>
